...
In the [Kanban board](/docs/views/kanban-board/), a compact count on each thread card shows how many native agents belong to that thread and follows the same active-versus-faint color rule. Open the thread or Agents List detail to inspect them.
